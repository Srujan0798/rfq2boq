...
The complete, crystal-clear picture of how this project is organized and how work flows through it. Read this once and you understand everything.
...
│   ├── wave2/               │ HISTORICAL — only A0 + INDEX kept (rest superseded)
│   ├── wave3/               │ HISTORICAL — B1 + B2 (both DONE)
│   └── archive/
...
│                      OWNER (Srujan)                │
│  - Approves plans                                  │
│  - Copies prompts from prompts/hybrid/phaseN/      │
...
| What task is next? | `prompts/hybrid/INDEX.md` |
