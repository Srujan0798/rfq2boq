...
| Prompt | Purpose | File |
|--------|---------|------|
| ORC_PROMPT | Professor simulation, brutal review | prompts/ORC_PROMPT.md |
| GURU_PROMPT | Orchestrator instructions | prompts/GURU_PROMPT.md |
| VERIFICATION_PROMPT | Line-by-line code + theory check | prompts/VERIFICATION_PROMPT.md |
