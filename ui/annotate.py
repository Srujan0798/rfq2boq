    ...
    with col_left:
        ...
        correction_type = st.selectbox(
            ...
            index=(
                ...
                .index(entity_type) if entity_type in ["MATERIAL", "QUANTITY", "UNIT", "LOCATION", "DIMENSION", "STANDARD", "ACTION", "GRADE"]
                else 0
            ),
        )

        reviewer_notes = st.text_area("Reviewer notes (optional):", value=current_task.get("reviewer_notes", ""), height=100)
