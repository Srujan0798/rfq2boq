...
class ConstructionEntityRuler:
    ...
    def build_patterns(self) -> list[dict]:
        ...
        action_patterns = [
            {"label": "ACTION", "pattern": [{"TEXT": {"REGEX": r"Supply|Install|Provide|Lay|Erect|Apply|Fix|Construct|Build|Pour|Cast|Fabricate"}}]},
        ]
    ...
    def create_ruler(self, nlp: spacy.Language | None = None) -> EntityRuler:
        ...
        self.ruler = nlp.add_pipe("entity_ruler", name="construction_ruler")
