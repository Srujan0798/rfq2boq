...
KEYWORDS = {
    "building": ["building", "residential", "commercial", "apartment", "office", "school", "hospital", "rcc", "foundation", "floor", "ceiling", "wall", "plaster"],
    "road": ["road", "highway", "pavement", "carriageway", "embankment", "subgrade", "wbm", "bm", "dbc", "pc", "km", "stone", "aggregate"],
    "bridge": ["bridge", "girder", "pier", "abutment", "deck", "span", "prestress", "psc", "box"],
    "electrical": ["electrical", "wiring", "cable", "conduit", "switch", "fixture", "load", "ampere", "voltage", "transformer"],
