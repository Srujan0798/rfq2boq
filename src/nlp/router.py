...
PROJECT_TYPE_KEYWORDS = {
    ProjectType.BUILDING: [
        "building", "residential", "commercial", "apartment", "office", "hospital",
        "school", "hospital", "floor", "column", "beam", "slab", "wall", "foundation",
    ],
    ProjectType.ROAD: [
        "road", "highway", "pavement", "asphalt", "bitumen", "crusher", "granular",
        "subgrade", "pavement", "lane", "carriageway", "shoulder", "median",
    ],
    ProjectType.BRIDGE: [
        "bridge", "flyover", "culvert", "abutment", "pier", "girder", "span",
        "foundation", "pile", "precast", "launching", "segmental",
    ],
    ProjectType.ELECTRICAL: [
        "electrical", "cable", "wire", "conduit", "switch", "socket", "db", "panel",
        "transformer", "generator", "lighting", "earthing", "mcb", "mccb",
    ],
    ProjectType.PLUMBING: [
        "plumbing", "pipe", "pvc", "cpvc", "gi", "water", "drain", "sewage",
        "sanitary", "fixture", "tap", "valve", "pump", "tank", "cistern",
    ],
}
