...
The canonical task path for the internship. See [`docs/HYBRID_PLAN.md`](../../docs/HYBRID_PLAN.md) for rationale and [`prompts/hybrid/WORKFLOW.md`](WORKFLOW.md) for dispatch protocol.
