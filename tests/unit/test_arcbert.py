...
class TestARCBERTNERModuleStructure:
    ...
    @pytest.mark.skip(reason="scripts/download_arcbert.py removed in Wave 1 cleanup")
    ...
    def test_module_has_required_class(self):
        ...
        spec = importlib.util.spec_from_file_location("arcbert_ner", "src/nlp/ner/arcbert_ner.py")
    ...
    @pytest.mark.skip(reason="scripts/finetune_arcbert_ner.py removed in Wave 1 cleanup")
