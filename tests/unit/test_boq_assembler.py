...
class TestBOQAssembler:
    ...
    def test_assemble_with_quantity_and_unit(self):
        ...
        # P3_04: "bags" normalizes to the canonical "bag" via the
        # shared alias table.  The old behavior (returning "bags" as
        # a non-canonical form) was the source of subtle row-match
        # mismatches in fidelity audits.
