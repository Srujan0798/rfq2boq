...
class TestResolveConflicts:
    ...
    def test_bert_wins_for_material(self):
        ...
        pattern = [{"type": "MATERIAL", "text": "cement", "confidence": 0.90, "source": "pattern", "start": 5, "end": 11}]
        result = resolve_conflicts(bert, pattern)
    ...
    def test_dictionary_entities_included(self):
        ...
        dictionary = [{"type": "MATERIAL", "text": "cement", "confidence": 0.85, "source": "dictionary", "start": 5, "end": 11}]
...
class TestEdgeCases:
    ...
    def test_all_candidates_disagree(self):
        bert = EntityCandidate({"type": "DIMENSION", "text": "cement", "confidence": 0.82, "source": "bert", "start": 0, "end": 5})
        pattern = EntityCandidate({"type": "DIMENSION", "text": "cement", "confidence": 0.89, "source": "pattern", "start": 0, "end": 5})
        dictionary = EntityCandidate({"type": "DIMENSION", "text": "cement", "confidence": 0.92, "source": "dictionary", "start": 0, "end": 5})
...
class TestThresholdConfidenceStrategy:
    def test_threshold_logic_wins(self):
        bert = EntityCandidate({"type": "MATERIAL", "text": "cement bag", "confidence": 0.85, "source": "bert", "start": 0, "end": 10})
        pattern = EntityCandidate({"type": "MATERIAL", "text": "cement bag", "confidence": 0.45, "source": "pattern", "start": 0, "end": 10})
        strategy = ThresholdConfidenceStrategy()
        result = strategy.resolve([bert, pattern])
        assert result.source == "bert"

    def test_no_margin_no_win(self):
        bert = EntityCandidate({"type": "MATERIAL", "text": "cement", "confidence": 0.75, "source": "bert", "start": 0, "end": 5})
        pattern = EntityCandidate({"type": "MATERIAL", "text": "cement", "confidence": 0.65, "source": "pattern", "start": 0, "end": 5})
        strategy = ThresholdConfidenceStrategy()
        result = strategy.resolve([bert, pattern])
        assert result.source == "pattern"

    def test_boundary_threshold(self):
        bert = EntityCandidate({"type": "MATERIAL", "text": "steel", "confidence": 0.60, "source": "bert", "start": 0, "end": 5})
        pattern = EntityCandidate({"type": "MATERIAL", "text": "steel", "confidence": 0.45, "source": "pattern", "start": 0, "end": 5})
        strategy = ThresholdConfidenceStrategy()
        result = strategy.resolve([bert, pattern])
        assert result.source == "pattern"

    def test_single_candidate(self):
        cand = EntityCandidate({"type": "MATERIAL", "text": "cement", "confidence": 0.80, "source": "bert", "start": 0, "end": 5})
        strategy = ThresholdConfidenceStrategy()
...
class TestTypeSpecificStrategy:
    def test_quantity_pattern_wins_high_conf(self):
        pattern = EntityCandidate({"type": "QUANTITY", "text": "500", "confidence": 0.65, "source": "pattern", "start": 0, "end": 3})
        model = EntityCandidate({"type": "QUANTITY", "text": "500", "confidence": 0.80, "source": "bert", "start": 0, "end": 3})
        strategy = TypeSpecificStrategy()
        result = strategy.resolve([model, pattern])
        assert result.source == "pattern"

    def test_quantity_model_wins_low_pattern_conf(self):
        pattern = EntityCandidate({"type": "QUANTITY", "text": "500", "confidence": 0.55, "source": "pattern", "start": 0, "end": 3})
        model = EntityCandidate({"type": "QUANTITY", "text": "500", "confidence": 0.80, "source": "bert", "start": 0, "end": 3})
        strategy = TypeSpecificStrategy()
        result = strategy.resolve([model, pattern])
        assert result.source == "bert"
    ...
    def test_material_model_wins_high_conf(self):
        model = EntityCandidate({"type": "MATERIAL", "text": "cement", "confidence": 0.75, "source": "bert", "start": 0, "end": 5})
        pattern = EntityCandidate({"type": "MATERIAL", "text": "cement", "confidence": 0.85, "source": "pattern", "start": 0, "end": 5})
        strategy = TypeSpecificStrategy()
        result = strategy.resolve([model, pattern])
        assert result.source == "bert"

    def test_grade_rules_wins_very_high_conf(self):
        pattern = EntityCandidate({"type": "GRADE", "text": "M20", "confidence": 0.85, "source": "pattern", "start": 0, "end": 3})
        model = EntityCandidate({"type": "GRADE", "text": "M20", "confidence": 0.90, "source": "bert", "start": 0, "end": 3})
        strategy = TypeSpecificStrategy()
        result = strategy.resolve([model, pattern])
        assert result.source == "pattern"

    def test_location_model_wins_high_conf(self):
        model = EntityCandidate({"type": "LOCATION", "text": "ground floor", "confidence": 0.80, "source": "bert", "start": 0, "end": 11})
        pattern = EntityCandidate({"type": "LOCATION", "text": "ground floor", "confidence": 0.90, "source": "pattern", "start": 0, "end": 11})
        strategy = TypeSpecificStrategy()
        result = strategy.resolve([model, pattern])
        assert result.source == "bert"

    def test_both_low_confidence_rules_default(self):
        pattern = EntityCandidate({"type": "MATERIAL", "text": "cement", "confidence": 0.50, "source": "pattern", "start": 0, "end": 5})
        model = EntityCandidate({"type": "MATERIAL", "text": "cement", "confidence": 0.45, "source": "bert", "start": 0, "end": 5})
        strategy = TypeSpecificStrategy()
        result = strategy.resolve([model, pattern])
        assert result.source == "pattern"
...
class TestHybridEnsembleStrategy:
    def test_model_weighted_wins(self):
        model = EntityCandidate({"type": "MATERIAL", "text": "steel", "confidence": 0.90, "source": "bert", "start": 0, "end": 5})
        pattern = EntityCandidate({"type": "MATERIAL", "text": "steel", "confidence": 0.90, "source": "pattern", "start": 0, "end": 5})
    ...
    def test_quantity_pattern_weighted(self):
        model = EntityCandidate({"type": "QUANTITY", "text": "500", "confidence": 0.80, "source": "bert", "start": 0, "end": 3})
        pattern = EntityCandidate({"type": "QUANTITY", "text": "500", "confidence": 0.80, "source": "pattern", "start": 0, "end": 3})
        strategy = HybridEnsembleStrategy()
        result = strategy.resolve([model, pattern])
        assert result.source == "pattern"

    def test_grade_rules_heavily_weighted(self):
        model = EntityCandidate({"type": "GRADE", "text": "Fe500", "confidence": 0.80, "source": "bert", "start": 0, "end": 4})
        pattern = EntityCandidate({"type": "GRADE", "text": "Fe500", "confidence": 0.80, "source": "pattern", "start": 0, "end": 4})
        strategy = HybridEnsembleStrategy()
        result = strategy.resolve([model, pattern])
        assert result.source == "pattern"
