...
class TestHighlightEntities:
    @pytest.mark.skip(reason="highlight_entities not yet implemented in ui/app.py")
...
class TestRenderEntityLegend:
    @pytest.mark.skip(reason="render_entity_legend not yet implemented in ui/app.py")
