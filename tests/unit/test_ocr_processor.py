...
class TestOCRProcessor:
    ...
    def test_process_pdf_returns_ocr_result(self, mock_process_image):
        ...
        mock_process_image.return_value = type("MockResult", (), {"pages": [mock_page], "conf_avg": 0.85})()
    ...
    def test_process_pdf_multiple_pages(self, mock_process_image):
        ...
        mock_pages = [OCRPage(page_number=i, text=f"Page {i}", lines=[], conf_avg=0.85) for i in range(1, 3)]
        mock_result = type("MockResult", (), {"pages": mock_pages, "conf_avg": 0.85})()
    ...
    def test_process_image_returns_result(self):
        ...
        with patch("pytesseract.image_to_data") as mock_ocr:
            ...
            with patch("PIL.Image.open") as mock_img:
                ...
                with patch.object(OCRProcessor, "_preprocess_image", lambda self, img: img):
                    processor = OCRProcessor()
